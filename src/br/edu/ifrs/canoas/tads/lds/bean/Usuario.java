 ...
 * Proposito da Classe: Classe que se relacionar� com as demais classes do sistema.
 *         
 */
/**Miromar contribuiu com a coloca��o de alguns atributos e relacionamento com a classe Endereco
...
public class Usuario extends BaseEntity<Long> implements Serializable {
	...
	/*
	 * C�digo foi comentado durante teste na tentativa de buscar solu��o para
	 * idioma de usu�rio
	 */
	...
	public void onUnselect(UnselectEvent event) {
		FacesContext context = FacesContext.getCurrentInstance();
		context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
				"Item n�o Selecionado", event.getObject().toString()));
	}

...
//			maps.put("nascimento", "30/06/94");
//			maps.put("genero", "Masculino");
//			maps.put("tiposanguineo","B+");
	
			//exames
//			maps.put("alta", "10/10/14");
//			maps.put("internacao", "09/10/14");
//			maps.put("laudo", "CID 123321");
//			maps.put("observacoes","Nao constam observações.");
//			maps.put("solicitante","Dr teste1");
//			maps.put("responsavel", "Dra Teste 2");
//			
//			UsuarioReportBean usuario = new UsuarioReportBean();
//			usuario.setNome("Luciano");
//			usuario.setNascimento("30/06/1994");

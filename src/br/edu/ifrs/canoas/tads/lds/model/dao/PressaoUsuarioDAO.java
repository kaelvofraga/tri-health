...
public class PressaoUsuarioDAO extends BaseDAO< PressaoUsuario, Long>{
	...
	/*
	 * Esta classe busca por registros de 'PressaoUsuario' salvos na base de
	 * dados que estejam relacionados a um determinado Usuário.
	 * 
	 * @param usuario Objeto do tipo Usuario do qual deseja buscar registros de objetos "PressaoUsuario"
	 */

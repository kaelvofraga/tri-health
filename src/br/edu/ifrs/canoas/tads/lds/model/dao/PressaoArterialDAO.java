...
public class PressaoArterialDAO extends BaseDAO<PressaoArterial, Long>
	...
	/*
	 * Esta classe busca por registros de 'PressaoArterial' salvos na base de
	 * dados que estejam relacionados a um determinado Usuário.
	 * 
	 * @param usuario Objeto do tipo Usuario do qual se deseja buscar registros de pressão arterial
	 */
	 ...
	 * 
	 * @param data Campo do tipo data pela qual serão pesquisados registros de pressão arterial.
	 * 
	 */

...
public class ManterExameUrinaService {
	...
	public boolean salvaExameUrinaUsuario(ExameUrinaUsuario exameUrina) {
		if (exameUrina.getItensExame() == null || exameUrina.getItensExame().isEmpty()
			...
			Mensagens.define(FacesMessage.SEVERITY_ERROR,"manterExameUrina.cadastro.erro.nulo");
			return false;
		} else {
			try {
				...
				Mensagens.define(FacesMessage.SEVERITY_ERROR,"manterExameUrina.cadastro.erro");
				return false;
			}
	...
	/**
	 * @brief Metodo que realiza busca no banco de dados os exames de urina do usuário através 
	 * de critério informado. Retorna lista de ExameUrinaUsuario.
	...
	/**
	 * @brief Metodo que valida os campos e altera no banco de dados informaçõesdo exameUrinaUsuario. 
	...
	public boolean alteraExameUrinaUsuario(ExameUrinaUsuario exameUrina) {
		try {
			...
			Mensagens.define(FacesMessage.SEVERITY_ERROR,"manterExameUrina.altera.excecao.erro");
			return false;
		}
	}
	/**
	...
	public boolean excluiExameUrinaUsuario(ExameUrinaUsuario exameUrina) {
		try {
			...
			Mensagens.define(FacesMessage.SEVERITY_ERROR,"manterExameUrina.exclui.excecao.erro");
			return false;
		}
	}
}
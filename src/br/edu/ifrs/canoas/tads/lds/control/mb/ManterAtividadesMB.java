...
/** ManageBean das views de Manter e Listar Atividades F�sicas
* @author Kael Fraga
* @since 07/05/2015
* */
@Named
...
public class ManterAtividadesMB implements Serializable {
	...
	/** 
	 * @brief Busca atividades relacionadas ao usu�rio logado de acordo com um crit�rio de pesquisa.	  	 		  
	 * @param void
	 * @return void
	 * */
	public void busca(){
	...
	/** 
	 * @brief Verifica se a atividade atual est� sendo inserida nova ou atualizada uma antiga.	  	 		  
	 * @param void
	 * @return true se est� atualizando atividade ou false se n�o.
	 * */
	...
	/** 
	 * @brief Atribui valor de calorias queimadas a atividadeUsuario que est� sendo trabalhada.	  	 		  
	 * @param void
	 * @return void
	 * */

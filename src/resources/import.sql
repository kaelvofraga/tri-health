...
insert into TipoExameUrina (id, tipo) values (3,'Corpos Cet�nicos');
insert into TipoExameUrina (id, tipo) values (4,'Densidade');
insert into TipoExameUrina (id, tipo) values (5,'pH');
insert into TipoExameUrina (id, tipo) values (6,'Prote�nas');
insert into TipoExameUrina (id, tipo) values (7,'Urobilinog�nio');
insert into TipoExameUrina (id, tipo) values (8,'Nitrito');
insert into TipoExameUrina (id, tipo) values (9,'Hemoglobina');
insert into TipoExameUrina (id, tipo) values (10,'Leuc�citos');
insert into TipoExameUrina (id, tipo) values (11,'Hem�cias');
insert into TipoExameUrina (id, tipo) values (12,'C�lulas Epiteliais');
insert into TipoExameUrina (id, tipo) values (13,'Bacteri�ria');

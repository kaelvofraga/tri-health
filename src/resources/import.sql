...
insert into Idioma (id, nome) values (1000, 'Portugu�s' );
insert into Idioma (id, nome) values (1001, 'Ingl�s' );
insert into Idioma (id, nome) values (1002, 'Espanh�l' );
insert into Idioma (id, nome) values (1003, 'Franc�s' );
